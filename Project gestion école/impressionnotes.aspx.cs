...
{
    public partial class impressionnotes : System.Web.UI.Page
    {
        MOS p = new MOS();
        ...
        public void etude()
        {
            ...
            DropDownList1.DataTextField = "prénom";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            p.cmd = new System.Data.SqlClient.SqlCommand("exec p1 " + int.Parse(DropDownList1.SelectedValue) , p.con);
            p.dap = new System.Data.SqlClient.SqlDataAdapter(p.cmd);
            DataTable dt2 = new DataTable();
            p.dap.Fill(dt2);
            rpt.Load(Server.MapPath("CrystalReportNote.rpt"));
