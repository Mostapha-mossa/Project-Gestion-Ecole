<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IMPRESSIONCLASSE.aspx.cs" Inherits="Project_gestion_école.IMPRESSIONCLASSE" %>
        ...
        <div>
         <tr>
               <div>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" Width="157px">
        </asp:DropDownList>
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Button" Width="125px" />
        ...
        <br />
             <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                 <Report FileName="CrystalReportCLASSE.rpt">
            </Report>
             </CR:CrystalReportSource>
</div>
          <%--<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="CrystalReportNote.rpt">
            </Report>
        </CR:CrystalReportSource>--%>
        <br />
    </div>
