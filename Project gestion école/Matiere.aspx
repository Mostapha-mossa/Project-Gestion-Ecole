<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Matiere.aspx.cs" Inherits="Project_gestion_école.Matiere" %>
...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Matiere</h1>
        <div>
        <tr>
                <td class="text-right">Code Matière:</td>
                <td>
                    <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" ></asp:TextBox>
                </td>
            </tr>
             <tr>
                <td class="text-right">Nom Matière:</td>
                <td>
                    <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" ></asp:TextBox>
                </td>
            </tr>
         <tr>
                <td class="text-right">Nombre heure:</td>
                <td>
