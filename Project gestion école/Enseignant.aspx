<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Enseignant.aspx.cs" Inherits="Project_gestion_école.Enseignant" %>
...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div>
         <tr>
                <td class="text-right">Code Enseignant:</td>
                <td>
        ...
        <tr>
            ...
            <tr>
                <td class="text-right">Date D'embauche:</td>
                <td>
        ...
        <tr>
                <td class="text-right">Spécialité :</td>
                <td>
