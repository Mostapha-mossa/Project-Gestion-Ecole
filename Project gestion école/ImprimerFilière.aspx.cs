...
{
    public partial class ImprimerFilière : System.Web.UI.Page
    {
        MOS p = new MOS();
        notes nt = new notes();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    p.connecter();
                    CrystalReportFilière cr = new CrystalReportFilière();
                    p.cmd = new System.Data.SqlClient.SqlCommand("exec p4 ", p.con);
                    p.dap = new System.Data.SqlClient.SqlDataAdapter(p.cmd);
                    DataTable dt2 = new DataTable();
                    p.dap.Fill(dt2);
                    rpt.Load(Server.MapPath("CrystalReportFilière.rpt"));
