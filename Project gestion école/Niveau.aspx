<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Niveau.aspx.cs" Inherits="Project_gestion_école.Niveau" %>
...
<a href="Niveau.aspx" class="list-group-item list-group-item-action bg-light">Niveau</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Niveau</h1>
        <div>
       <tr>
                <td class="text-right">Code Niveau:</td>
                <td>
                    <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="text-right">Nom Niveau :</td>
                <td>
                    <asp:DropDownList ID="DropDownList" CssClass="form-control" runat="server" AutoPostBack="True"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="text-right">Frais Inscription:</td>
                <td>
                    <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td>&nbsp;</td><br />
                    ...
                    <asp:Button ID="Button3" runat="server" Text="Modifier" class="btn-success" OnClick="Button2_Click"  />
                    <asp:Button ID="Button2" runat="server" Text="Nouveau" class="btn-danger" OnClick="Button3_Click"  />
                </td>
            </tr>
               &nbsp;
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" Width="100%" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" ForeColor="#333333" AutoGenerateSelectButton="True" GridLines="None">
