<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Etudiant.aspx.cs" Inherits="Project_gestion_école.Etudiant" %>
...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div>
            <tr>
                <td class="text-right">Num d'Inscription:</td>
                <td>
        ...
        <tr>
                <td class="text-right">CNI :</td>
                <td>
                    <asp:TextBox ID="TextBox5" CssClass="form-control" runat="server" ></asp:TextBox>
                </td>
            </tr>
        <tr>
                <td class="text-right">CNE :</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox10" CssClass="form-control" runat="server" type="Date"></asp:TextBox>
                </td>
            </tr>
        <tr>
                <td class="text-right">Diplôme :</td>
                <td>
