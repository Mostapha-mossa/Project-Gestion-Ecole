<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Filiere.aspx.cs" Inherits="Project_gestion_école.Filiere" %>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div>
            ...
            <tr>
                <td class="text-right"> Filiere :</td>
                <td>
                    <asp:DropDownList ID="DropDownList" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList_SelectedIndexChanged">
        </asp:DropDownList>
                </td>
            </tr>
        <tr>
                <td class="text-right">Niveau :</td>
                <td>
        ...
        <tr>
                <td class="text-right">Secteur :</td>
                <td>
