<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Enseignantmatiereaffectation.aspx.cs" Inherits="Project_gestion_école.Enseignantmatiereaffectation" %>
...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div>
          <tr>
                <td class="text-right">Donnez Le Code D'Affectation:</td>
                <td>
                    <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" ></asp:TextBox>
                </td>
            </tr>
        <tr>
                <td class="text-right">Selectionner l'enseignant :</td>
                <td>
             ...
             <tr>
                <td class="text-right">Donnez la Filière:</td>
                <td>
        ...
        <tr>
                <td class="text-right">Choiser la Matiere:</td>
                <td>
                    <asp:DropDownList ID="DropDownList2" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" DataSourceID="SqlDataSource1" DataTextField="nomMat" DataValueField="codeM">
        </asp:DropDownList>
                </td>
            </tr> 
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projcoleConnectionString %>" SelectCommand="SELECT Matière.* FROM Matière INNER JOIN Filière ON Matière.codeFili = Filière.codeF WHERE (Filière.codeF = @codef)">
            <SelectParameters>
