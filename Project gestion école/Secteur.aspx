<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Secteur.aspx.cs" Inherits="Project_gestion_école.Secteur" %>
...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Secteur</h1>
        <div>
         <tr>
                <td class="text-right">Code Secteur:</td>
                <td>
                    <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="text-right">Nom Secteur :</td>
                <td>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" Width="100%"  ForeColor="#333333" AutoGenerateSelectButton="True" GridLines="None" OnRowDeleting="GridView1_RowDeleting" >
