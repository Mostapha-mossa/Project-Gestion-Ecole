<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImprimerFilière.aspx.cs" Inherits="Project_gestion_école.ImprimerFilière" %>
    ...
    $("#menu-toggle").click(function(e) {
      ...
      $("#wrapper").toggleClass("toggled");
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="CrystalReportFilière.rpt">
            </Report>
